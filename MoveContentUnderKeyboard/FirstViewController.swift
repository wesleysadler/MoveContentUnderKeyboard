...
class FirstViewController: UIViewController {
    ...
    func registerForKeyboardNotifications() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(detailView, selector: #selector(detailView.keyboardWasShown), name: UIKeyboardWillShowNotification, object: nil)
        NSNotificationCenter.defaultCenter().addObserver(detailView, selector: #selector(detailView.keyboardWillBeHidden), name: UIKeyboardWillHideNotification, object: nil)
    }
